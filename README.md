# Cursor Usage Extension v1.1.1 by TAEINN
...
- [Rust 설치 페이지](https://www.rust-lang.org/tools/install)에서 `rustup-init.exe`로 설치
...
- 공식 가이드: [Tauri v2 Prerequisites](https://v2.tauri.app/start/prerequisites/)
- macOS는 `xcode-select --install`(Xcode Command Line Tools) 설치가 필요할 수 있습니다.
- Windows는 Visual Studio C++ Build Tools / WebView2 Runtime 설치가 필요할 수 있습니다.
